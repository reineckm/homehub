...
// WLAN credentials
const char *ssid = "mysecretplan";
const char *password = "n1xb3zQy";

// parse.com credentials
const String parseAppId = "RksZQiXkgmk3uDMep7m8bpAiFvP7P1475jOvRxXo";
const String parseApiKey = "qVJGtYl5rOqNshRt0RqLB0IOtmjcRgnJeTglpGJ0"; 
